...
- Observations are gathered from diverse empirical surveillance streams:
  ...
  - **County 6th Grade Surveys**: Right-censored dose 2 coverage at age 11 across all three counties.
...
age, cohort, and dose associated with each survey outcome. Every record in `observations`
...
`imuGAP` supports observations at intermediate resolutions, here illustrated by a routine county-wide tally for entry to middle school:
...
all 24 elementary schools grouped by county, comparing empirical survey counts against the
