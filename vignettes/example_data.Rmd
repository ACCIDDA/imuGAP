...
- Observations are gathered from diverse empirical surveillance streams:
  ...
  - **County 6th Grade Surveys**: Right-censored dose 2 coverage at age 11 across all `r length(county_names)` counties.
...
- During Bayesian model fitting, the likelihood accounts for the right-censoring mechanism, ensuring that lower-bound surveillance records accurately inform the latent process without downwardly biasing coverage trajectories.
