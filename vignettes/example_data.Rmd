...
The following plot compares observed 6th grade county survey outcomes against underlying latent ground
truths. This illustrates how empirical surveillance streams sample discrete slices (subject to
unobserved cohorts and right-censoring), while the `imuGAP` process model infers continuous
cohort trajectories across unobserved ages and birth cohorts:
