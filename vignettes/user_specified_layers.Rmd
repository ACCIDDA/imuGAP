...
Support for **flexible location layers** allows `imuGAP` to adapt to whatever location hierarchy
you provide:
...
- If you provide sub-populations like counties (**2 layers**) or sub-sub-populations like schools
  (**3 layers**), the model automatically builds hierarchical random offsets down the location tree
...
- For an overview of the core model fitting and prediction workflow, see **[Getting Started with imuGAP](imuGAP.html)**.
