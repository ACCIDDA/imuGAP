...
array[n_obs_unmixed_uncensored] int<lower=1, upper=n_obs_uncensored> unmixed_orig_order_uncensored;
...
array[n_obs_mixed_uncensored] int<lower=1, upper=n_obs_uncensored> mixed_orig_order_uncensored;
