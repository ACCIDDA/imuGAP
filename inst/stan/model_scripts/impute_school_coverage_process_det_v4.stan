...
functions {
  #include stan/functions/convenience.stan
}
...
model {
  ...
  if (!predict_mode) {
    ...
    // #include stan/model/cnty_sch_linear_calc.stan // yields phi
    #include stan/model/cnty_sch_calc.stan // yields phi
    #include stan/model/static_lambda_calc.stan // yields unrolled dose cdf
    #include stan/model/p_obs_calc.stan // yields p_obs
