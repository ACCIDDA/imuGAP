...
test_that("structural data and transformed indices create compliant lookup and range mappings", {
  ...
  data_list <- list(
    ...
    # Uncensored data
    n_obs_uncensored = 2L,
    y_obs_uncensored = c(10L, 10L),
    y_smp_uncensored = c(20L, 20L),
    n_obs_unmixed_uncensored = 1L,
    unmixed_orig_order_uncensored = as.array(1L),
    ...
    mixed_orig_order_uncensored = as.array(2L),
    ...
    unmixed_orig_order_right = integer(0),
    ...
    mixed_orig_order_right = integer(0),
